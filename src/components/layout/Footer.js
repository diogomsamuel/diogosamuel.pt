...
export const Footer = () => {
  ...
  return (
    <footer className="bg-background-dark-lighter py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-4 text-text-muted">
              Sharing my journey through fitness, lifestyle, and personal growth.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#social" className="text-text-muted hover:text-foreground transition-colors">
                  Social
                </Link>
              </li>
              <li>
        ...
        {/* Copyright */}
        <div className="mt-12 pt-8 border-t border-background-dark text-center text-text-muted">
          <p>&copy; {currentYear} Diogo Samuel. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
