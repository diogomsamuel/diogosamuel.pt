          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="p-3 rounded-full bg-background hover:bg-background-dark transition-colors text-[#E4405F]"
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="p-3 rounded-full bg-background hover:bg-background-dark transition-colors text-[#FF0000]"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="p-3 rounded-full bg-background hover:bg-background-dark transition-colors text-white"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
