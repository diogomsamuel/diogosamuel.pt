...
export const ContentGridSection = () => {
  return (
    <section id="content-grid" className="py-16 relative overflow-hidden bg-white text-black text-center">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-2xl md:text-4xl font-black mb-12 uppercase"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative aspect-square overflow-hidden rounded-lg group flex flex-col justify-between"
          >
